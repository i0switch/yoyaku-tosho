...
| 単純依頼で誤発火する | 軽作業は対象外と明記する | 「単純な読取だけなら対象外」 |
...
4. **Scope** — 対象外や競合ケースの境界を必要に応じて入れる
...
## 5.5 metadata / 配布準備の評価

- [ ] `metadata.version` があるか
- [ ] `metadata.updated` があるか
- [ ] `metadata.changelog` があるか
- [ ] 共有・公開するなら README / ライセンスがあるか
- [ ] ZIPやフォルダ共有前提で不足ファイルがないか
